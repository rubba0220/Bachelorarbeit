...
for k in range(15):
    if eval(f'abs(roh{k+1}[0]-roh_{k+1}(pos_truth))/roh{k+1}[1] > 1.5'):
    ...
    if eval(f'abs(sigma{k+1}[0]-sigma_{k+1}(pos_truth))/sigma{k+1}[1] > 1.5'):
...
if abs(rohdm[0]-roh_dm(pos_truth))/rohdm[1] > 1.5:
